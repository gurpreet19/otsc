 ...
 */
@Component
public class TMFProductOfferingRouter extends RouteBuilder {
	
	
	private final Logger log = LoggerFactory.getLogger(TMFProductOfferingRouter.class);
	  
    @Override
    public void configure() throws Exception {
    	
    	from("direct:offerToTMFProductOfferingRoute")
    	.bean(TMFProductOfferingModel.class) 
    	...
    	.process(new Processor() {
            public void process(Exchange exchange) throws Exception { 
              	...
              	log.debug("Calling TMF Product Offering Creation API " + exchange.getIn().getBody());
              }
          })    	 
    	 ...
    	 .process(new Processor() {
			...
			public void process(Exchange exchange) throws Exception {
	           ...
	           if(code == 200 || code == 201){
	            	log.debug("Product Offering: " + exchange.getIn() + " Published Succesfully");
	            }
	            else{
	            	log.debug("Failed To Publish Product Offering: " + exchange.getIn().getBody());
	            }
			}
